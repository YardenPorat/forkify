...
export default class Recipe {
    ...
    parseIngredients(){
        ...
        const unitLong = ['tablespoons' ,'tablespoon', 'whole medium','whole','ounces' ,'ounce' ,'cups','pounds','teaspoons' ,'teaspoon' ,'package',]
        const unitShort = ['tbs'        ,'tbs'       , ''        ,'' ,'oz'     ,'oz'    ,'cup' ,'pound' ,'tsp','tsp'      ,'pack'  ]
        ...
        newIngredients = newIngredients.filter( e => !filterOut.some(e2 => e.toLowerCase().includes(e2)));
        ...
        newIngredients = newIngredients.map( el =>{
            ...
            //// any whitespaces start, then (, all until != )
    ...
    updateServings(type) {
        ...
        this.ingredients.forEach(ing => {
            ing.count = Math.round(((ing.count*(newServings / this.servings)) + Number.EPSILON) * 100) / 100;
